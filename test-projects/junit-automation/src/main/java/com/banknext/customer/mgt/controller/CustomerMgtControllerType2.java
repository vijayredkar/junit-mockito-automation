...
public class CustomerMgtControllerType2 {
    ...
    public CustomerMgtControllerType2(CustomerService customerServiceImplType1, AccountService accountService) {
    ...
    public ResponseEntity<Customer> getCustomerById(@PathVariable("id") int customerId){
        return customerServiceImplType1.getOptCustomerById(customerId)
