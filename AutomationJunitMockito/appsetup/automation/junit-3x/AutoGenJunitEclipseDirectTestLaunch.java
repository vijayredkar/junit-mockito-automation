...
@Component
public class AutoGenJunitEclipseDirectTestLaunch	
	{
	    ...
	    //@PostConstruct /* Uncomment only when you want to initiate from Eclipse. DO NOT ship this class */    
		public void initiate() throws Exception
		{
	    	/*
			 on Commented    : Auto-gen only 
			 				   ensure HARDCODED targets are uncommented
			 				   then run the SpringBoot Application
			 on UnCommented  : Junit run only
			 				   then run the Junit class	
	    	 */
		...
		private void captureEnv() 
		{
			...
			applicationBaseFilePath =  "C:\\Vijay\\Java\\projects\\junit-mockito-mgt\\test-projects\\junit-automation\\";
			applicationMainClassPath =  "C:\\Vijay\\Java\\projects\\junit-mockito-mgt\\test-projects\\junit-automation\\src\\main\\java\\com\\banknext\\customer\\mgt";
			automationTemplatesPath  = "C:\\Vijay\\Java\\projects\\junit-mockito-mgt\\test-projects\\junit-automation\\src\\main\\java\\com\\banknext\\customer\\mgt\\automation\\templates";
			
			//targetClassNameFullyQualified = "com.banknext.customer.mgt.event.publisher.CustomerTxnPublisherType1";		
			targetClassNameFullyQualified = "com.banknext.customer.mgt.event.consumer.CustomerTxnConsumerType1";
			
			//targetClassNameFullyQualified = "com.banknext.customer.mgt.controller.CustomerMgtControllerType1";
			//targetClassNameFullyQualified = "com.banknext.customer.mgt.controller.CustomerMgtControllerType2";
			//targetClassNameFullyQualified = "com.banknext.customer.mgt.controller.CustomerMgtControllerType3";
						
			//targetClassNameFullyQualified = "com.banknext.customer.mgt.service.CustomerServiceImplType1";
			//targetClassNameFullyQualified = "com.banknext.customer.mgt.service.CustomerServiceImplType2";
			//targetClassNameFullyQualified = "com.banknext.customer.mgt.service.CustomerServiceImplType3";
			
			
			
			/*
			applicationSetupDirPath =  "C:\\Vijay\\Java\\AutomationJunitMockito\\appsetup";
			applicationBaseFilePath =  "C:\\Vijay\\Java\\projects\\junit-mockito-mgt\\test-projects\\spring-boot-h2-database-crud\\";
			applicationMainClassPath =  "C:\\Vijay\\Java\\projects\\junit-mockito-mgt\\test-projects\\spring-boot-h2-database-crud\\src\\main\\java\\com\\bezkoder\\spring\\jpa\\h2";
			automationTemplatesPath  = "C:\\Vijay\\Java\\projects\\junit-mockito-mgt\\test-projects\\spring-boot-h2-database-crud\\src\\main\\java\\com\\bezkoder\\spring\\jpa\\h2\\automation\\templates";
			targetClassNameFullyQualified = "com.bezkoder.spring.jpa.h2.controller.TutorialController";
			*/
